...
\title{Semaine 4 - Fonctions usuelles}
...
\subparagraph{2}Soit $(u_n)_{n \in \mathbb{N}}$ la suite définie par $u_n=\sum_{k=0}^n 2^k \tanh(2^kx)$. Grâce à la question précédente, montrer que $(u_n)_{n \in \mathbb{N}}$ admet une limite lorsque $n \rightarrow +\infty$ et la déterminer.
