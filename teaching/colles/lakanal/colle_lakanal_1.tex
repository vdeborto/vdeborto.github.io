...
\subparagraph{2}En déduire une factorisation de $z^8+z^4+1$ en produit de polynômes de degré 2 à coefficients réels.
...
\subparagraph{2}Même question mais pour $1515!$
